...
- Drag / click any element to edit it, pick a colour scheme, save layouts as templates
- Download PNG (2400x1350)

Templates are saved in your browser. Use "Export all" to send them to the Telegram bot (@dexmoonupdaterbot).
